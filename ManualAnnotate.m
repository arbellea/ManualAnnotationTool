...
% Last Modified by GUIDE v2.5 28-Jun-2017 11:01:09
...
switch button
    case 'New'
        ...
        I1 = normalizeImage(double(I1),p(1),p(2));
        I2 = normalizeImage(double(I2),p(1),p(2));
        ...
        I1 = cast(I1,imType);
        I2 = cast(I2,imType);
        handles.low = double(min([I1(:);I2(:)]));
        handles.heigh = double(max([I1(:);I2(:)]));
    ...
    case 'Continue'
        ...
        set(handles.popCellList,'string',cellString);
        handles.low = double(min([userData.Images.Raw{1}(:);userData.Images.Raw{2}(:)]));
        handles.heigh = double(max([userData.Images.Raw{1}(:);userData.Images.Raw{2}(:)]));
        handles.im1 = imshow(userData.Images.Show{1},[handles.low, handles.heigh],'parent',handles.axes1);
        set(handles.im1,'hittest','on','tag','image1');
        handles.im2 = imshow(userData.Images.Show{2},[handles.low, handles.heigh],'parent',handles.axes2);
        guidata(handles.figure1,handles);
    case 'Cancel'
end
...
for frame = 1:size(userData.Cells,2)
    ...
    I = normalizeImage(double(userData.Images.Raw{frame}),handles.low,handles.heigh);
    ...
    if frame==1
        ...
        handles.im1 = imshow(userData.Images.Show{frame},[handles.low, handles.heigh],'parent',handles.axes1);
        %set(handles.im1,'buttonDownFcn',@DrawCell,'hittest','on','tag','image1');
        set(handles.im1,'hittest','on','tag','image1');
        ...
        handles.im2 = imshow(userData.Images.Show{frame},[handles.low, handles.heigh],'parent',handles.axes2);
        %set(handles.im2,'buttonDownFcn',@DrawCell,'hittest','on','tag','image2');
        set(handles.im2,'hittest','on','tag','image2');
...
function sldLow_Callback(hObject, eventdata, handles)
% hObject    handle to sldLow (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
...
userData = get(handles.figure1,'userdata');
r = get(hObject,'Max')-get(hObject,'Min');
v = (get(hObject,'Value')-get(hObject,'Min'))./r;
handles.low = double(max([userData.Images.Raw{1}(:);userData.Images.Raw{2}(:)]))*v;
handles.low = min(handles.low, handles.heigh);
guidata(handles.figure1,handles);
createContourMask(handles.figure1)

% --- Executes during object creation, after setting all properties.
function sldLow_CreateFcn(hObject, eventdata, handles)
% hObject    handle to sldLow (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
% --- Executes on slider movement.
function sldHeigh_Callback(hObject, eventdata, handles)
% hObject    handle to sldHeigh (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
...
r = get(hObject,'Max')-get(hObject,'Min');
v = (get(hObject,'Value')-get(hObject,'Min'))./r;
handles.heigh = double(max([userData.Images.Raw{1}(:);userData.Images.Raw{2}(:)]))*v;
handles.heigh = max(handles.low, handles.heigh);
guidata(handles.figure1,handles);
createContourMask(handles.figure1)

% --- Executes during object creation, after setting all properties.
function sldHeigh_CreateFcn(hObject, eventdata, handles)
% hObject    handle to sldHeigh (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function Iout =  normalizeImage(I,low,heigh)
Iout = double(I-low)./(heigh-low)*255;
Iout = uint8(max(0,(min(Iout,255))));


% --- Executes on button press in pbScribBG1.
function pbScribBG1_Callback(hObject, eventdata, handles)
% hObject    handle to pbScribBG1 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
switchFreezeGUI(handles.figure1,false)
BG = {};
...
while get(hObject,'Value')==1
    ...
    BG{i} =  imfreehand(handles.axes1,'Closed',false);
    p = wait(BG{i});
end
switchFreezeGUI(handles.figure1,true)


% --- Executes on button press in pbScribFG1.
function pbScribFG1_Callback(hObject, eventdata, handles)
% hObject    handle to pbScribFG1 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hint: get(hObject,'Value') returns toggle state of pbScribFG1


% --- Executes on button press in pbScribBG2.
function pbScribBG2_Callback(hObject, eventdata, handles)
% hObject    handle to pbScribBG2 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hint: get(hObject,'Value') returns toggle state of pbScribBG2


% --- Executes on button press in pbScribFG2.
function pbScribFG2_Callback(hObject, eventdata, handles)
% hObject    handle to pbScribFG2 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hint: get(hObject,'Value') returns toggle state of pbScribFG2
